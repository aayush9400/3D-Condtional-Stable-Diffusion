...
from networks.rnsvqvae import VQVAE, ReplaceCodebookCallback
...
def run(args):
    ...
    if args.train_vq:
        ...
        with strategy.scope():
            ...
            replace_codebook_callback = ReplaceCodebookCallback(model.get_nsvq_model(), batch_size=args.bs, frequency=2)
