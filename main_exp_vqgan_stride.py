...
from networks.vqgan_stride import VQGAN, WandbImageCallback, ReplaceCodebookCallback, EpochCounterCallback
...
def run_experiment(args, strategy, train_dataset, val_dataset):
    run_name = f"{args.channel_list}|{args.num_embedding}x{args.embedding_dim}|{args.disc_threshold}|{args.disc_loss_fn}|{args.dataset}|stride" 
